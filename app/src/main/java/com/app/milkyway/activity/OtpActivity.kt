...
import com.app.milkyway.databinding.ActivityOtpBinding
...
//
    ...
    private fun login() {
            ...
            if (result) {
                try {
                    ...
                    if (jsonObject.getBoolean(com.app.milkyway.helper.Constant.SUCCESS)) {
                        ...
                        session!!.setBoolean("is_logged_in", true)
                        session!!.setData(
                            com.app.milkyway.helper.Constant.USER_ID, jsonArray.getJSONObject(0).getString(
                                com.app.milkyway.helper.Constant.ID))
                        session.setData(
                            com.app.milkyway.helper.Constant.NAME, jsonArray.getJSONObject(0).getString(
                                com.app.milkyway.helper.Constant.NAME))
                        session.setData(
                            com.app.milkyway.helper.Constant.MOBILE, jsonArray.getJSONObject(0).getString(
                                com.app.milkyway.helper.Constant.MOBILE))
                        session.setData(
                            com.app.milkyway.helper.Constant.EMAIL, jsonArray.getJSONObject(0).getString(
                                com.app.milkyway.helper.Constant.EMAIL))
                        session.setData(
                            com.app.milkyway.helper.Constant.AGE, jsonArray.getJSONObject(0).getString(
                                com.app.milkyway.helper.Constant.AGE))
                        session.setData(
                            com.app.milkyway.helper.Constant.CITY, jsonArray.getJSONObject(0).getString(
                                com.app.milkyway.helper.Constant.CITY))
                        session.setData(
                            com.app.milkyway.helper.Constant.STATE, jsonArray.getJSONObject(0).getString(
                                com.app.milkyway.helper.Constant.STATE))
                        session.setData(
                            com.app.milkyway.helper.Constant.REFER_CODE, jsonArray.getJSONObject(0).getString(
                                com.app.milkyway.helper.Constant.REFER_CODE))
                        ...
                        if (message.equals("Your Mobile Number is not Registered")) {
                            ...
                            DialogUtils.showCustomDialog(this, ""+jsonObject.getString(com.app.milkyway.helper.Constant.MESSAGE))
                        }
        ...
        }, this, com.app.milkyway.helper.Constant.LOGIN, params, true)
