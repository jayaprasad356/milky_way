...
import com.app.milkyway.adapter.MyTeamAdapter
import com.app.milkyway.model.MyTeam
import com.app.milkyway.databinding.FragmentMyteamBinding
...
//        // Home Activity binding.rlHeader.visibility = View.GONE
        ...
        binding.tvTeamsize.text =  session.getData(com.app.milkyway.helper.Constant.TEAM_SIZE)
        binding.tvValidTeam.text =  session.getData(com.app.milkyway.helper.Constant.VALID_TEAM)
        ...
        binding.btnInvite.setOnClickListener {
            val shareBody = "Hey, I am using WeAgri App. It's a great app to earn money. Use my refer code " + session.getData(
                com.app.milkyway.helper.Constant.REFER_CODE) + " to get 100 coins on signup. Download the app from the link below.\n" + ""
    ...
    private fun referlist(level: String) {
        ...
        params[com.app.milkyway.helper.Constant.LEVEL] = level
        ...
        }, activity, com.app.milkyway.helper.Constant.TEAM_LIST, params, true)
