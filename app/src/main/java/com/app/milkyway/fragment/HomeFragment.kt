...
import com.app.milkyway.databinding.FragmentHomeBinding
            ...
            if (result) {
                try {
                    ...
                    if (jsonObject.getBoolean(Constant.SUCCESS)) {
                        ...
                        binding.tvName.text = "Hi " + session.getData(com.app.milkyway.helper.Constant.NAME)
                        binding.tvReferralCode.text =  session.getData(com.app.milkyway.helper.Constant.REFER_CODE)
